...
const pt_br_embeds: NamespaceEmbedsTranslation = {
	...
	about: {
		description:
			'{username} é um bot do Discord intuitivo e fácil de usar, conectado a https://paliapedia.com e foi criado por {developers}.',
	...
	weekly_wants: {
		...
		description:
			'A rotação de desejos semanais para {date} já está disponível! Você pode encontrar a lista completa de desejos semanais em {url}.'
	},
	miscellaneous: {
