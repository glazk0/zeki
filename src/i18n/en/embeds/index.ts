...
const en_embeds: BaseTranslation = {
	...
	about: {
		description: "{username} is an intuitive and user-friendly Discord bot connected to https://paliapedia.com and has been created by {developers}.",
	...
	weekly_wants: {
		...
		description: "The weekly wants rotation for {date} is now available! You can find the full list of weekly wants on {url}.",
	},
	miscellaneous: {
