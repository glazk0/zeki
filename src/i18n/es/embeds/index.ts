...
const es_embeds: NamespaceEmbedsTranslation = {
  ...
  about: {
    description: "{username} es un bot de Discord intuitivo y fácil de usar conectado a https://paliapedia.com y ha sido creado por {developers}.",
  ...
  weekly_wants: {
    ...
    description: "¡La rotación de deseos semanales para {date} ya está disponible! Puedes encontrar la lista completa de deseos semanales en {url}.",
  },
  miscellaneous: {
