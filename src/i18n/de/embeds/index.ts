...
const de_embeds: NamespaceEmbedsTranslation = {
	...
	item: {
		...
		ingredient_for_recipe: "Zutat für Rezept",
	...
	villager: {
		...
		relationship: "{type} level {level} - {levelName} (erfordert {requiredValue})",
	},
	weekly_wants: {
		title: "Wöchentliche Wünsche",
		description: "Die Wochenwünsche vom {date} sind jetzt verfügbar! Die vollständige Liste der Wochenwünsche findest du hier {url}.",
	},
	miscellaneous: {
