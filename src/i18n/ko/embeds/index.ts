...
const ko_embeds: NamespaceEmbedsTranslation = {
	...
	about: {
		description:
			'{username}은(는) https://paliapedia.com에 연결된 직관적이고 사용자 친화적인 Discord 봇으로, {developers}에 의해 만들어졌습니다.',
		statistics_name: '통계',
	...
	weekly_wants: {
		title: '주간 원하는 것 로테이션',
		description:
			'{date}의 주간 원하는 것 로테이션이 이제 사용 가능합니다! 전체 주간 원하는 것 목록은 {url}에서 확인할 수 있습니다.'
	},
	miscellaneous: {
