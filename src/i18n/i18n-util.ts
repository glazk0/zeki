...
export const locales: Locales[] = ["de", "en", "es", "fr", "it", "ja", "ko", "pt-br", "ru", "zh-hans", "zh-hant"];

export const namespaces: Namespaces[] = ["discord", "embeds", "interactions"];
...
export const i18nObject = (locale: Locales): TranslationFunctions => initI18nObject<Locales, Translations, TranslationFunctions, Formatters>(locale, loadedLocales[locale], loadedFormatters[locale]);

export const i18n = (): LocaleTranslationFunctions<Locales, Translations, TranslationFunctions> => initI18n<Locales, Translations, TranslationFunctions, Formatters>(loadedLocales, loadedFormatters);
