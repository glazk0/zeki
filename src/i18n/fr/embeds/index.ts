...
const fr_embeds: NamespaceEmbedsTranslation = {
	help: {
		...
		description:
			'Voici une liste de toutes mes commandes. Vous pouvez également les voir lorsque vous tapez «/» dans Discord.'
	},
	about: {
		description:
			'{username} est un bot Discord intuitif et convivial connecté à https://paliapedia.com et a été créé par {developers}',
	...
	weekly_wants: {
		...
		description:
			'La rotation hebdomadaire des demandes pour {date} est maintenant disponible! Vous pouvez trouver la liste complète des demandes hebdomadaires sur {url}.'
	},
	miscellaneous: {
