...
const it_embeds: NamespaceEmbedsTranslation = {
	...
	about: {
		description: "{username} è un Discord bot intuitivo e facile da usare, connesso a https://paliapedia.com ed è stato creato da {developers}.",
	...
	villager: {
		...
		relationship: "{type} livello {level} - {levelName} (Necessita {requiredValue})",
	},
	weekly_wants: {
		title: "Rotazione dei regali settimanali",
		description: "La lista dei regali settimanali ricercati a {date} è ora disponibile! Puoi trovare l'elenco completo al {url}.",
	},
	miscellaneous: {
